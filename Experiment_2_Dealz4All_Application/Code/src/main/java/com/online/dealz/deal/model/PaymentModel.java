package com.online.dealz.deal.model;
...
import com.online.dealz.deal.contract.PostconditionImpPayment;
import com.online.dealz.deal.contract.PreconditionImpPayment;
...
import com.online.dealz.deal.exception.DatabaseException;
import com.online.dealz.deal.exception.DuplicateRecordException;
import com.online.dealz.deal.util.JDBCDataSource;

public class PaymentModel {
	
private static Logger log = Logger.getLogger(PaymentModel.class);

	PreconditionImpPayment preconditionPayment = new PreconditionImpPayment();
	PostconditionImpPayment postconditionPayment = new PostconditionImpPayment();
	...
	public long add(PaymentBean bean) throws ApplicationException, DuplicateRecordException, ContractException {
		log.debug("Model add Started");
		//do pre condition check
		if (!preconditionPayment.checkPreConditionForModel_ADU(bean)){
			throw new ContractException("PreCondition exception");
		}
		Connection conn = null;
		int pk = 0;
		int paymentId = 0;
	...
	public void delete(PaymentBean bean) throws ApplicationException, ContractException {
	...
	public void update(PaymentBean bean) throws ApplicationException, DuplicateRecordException, ContractException {
	...
	public List search(PaymentBean bean) throws ApplicationException, ContractException {
        return search(bean, 0, 0);
    }

   
    public List search(PaymentBean bean, int pageNo, int pageSize)
			throws ApplicationException, ContractException {
        log.debug("Model search Started");
		//do pre condition check
		if (!preconditionPayment.checkPreConditionForModel_FindBy(pageNo,pageSize)){
			throw new ContractException("PreCondition exception");
		}
        ...
        //do postCondition check
        if (!postconditionPayment.checkPreConditionForModel_List(list)){
			throw new ContractException("PostCondition exception");
		}
        return list;
    }
