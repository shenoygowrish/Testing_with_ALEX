<%@page import="com.online.dealz.deal.controller.ProductCtl"%>
...
<div class="col-md-5">
    <div class="form-area">  
       ...
       <jsp:useBean id="bean" class="com.online.dealz.deal.bean.ProductBean"
        ...
        <input type="submit" name="operation" id="save"
