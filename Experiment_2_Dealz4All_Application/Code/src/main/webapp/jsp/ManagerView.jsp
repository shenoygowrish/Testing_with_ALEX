<%@page import="com.online.dealz.deal.controller.ManagerCtl"%>
<%@page import="com.online.dealz.deal.util.HTMLUtility"%>
...
<div class="col-md-5">
    <div class="form-area">  
       ...
       <jsp:useBean id="bean" class="com.online.dealz.deal.bean.ManagerBean"
